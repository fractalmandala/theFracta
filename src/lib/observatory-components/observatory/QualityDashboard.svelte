...
<section class="box gap-md pad-md" aria-labelledby="quality-title">
	<header class="box gap-3xs">
		...
		<h2 id="quality-title" class="text-lg weight-600">Quality health</h2>
		<p class="text-muted text-sm">These values are descriptive signal aggregates; no causal claims are inferred.</p>
	</header>
	...
	{#if signals}
		<dl class="card-grid">
			<div class="row xbetween gap-sm text-sm card border pad-sm box gap-3xs">
				...
				<dd class="text-md weight-600">{signals.scored_sessions}</dd>
			</div>
			<div class="row xbetween gap-sm text-sm card border pad-sm box gap-3xs">
				<dt class="text-xs weight-500 text-muted tt-u">Unscored sessions</dt>
				<dd class="text-md weight-600">{signals.unscored_sessions}</dd>
			</div>
			<div class="row xbetween gap-sm text-sm card border pad-sm box gap-3xs">
			...
			<div class="row xbetween gap-sm text-sm card border pad-sm box gap-3xs">
				...
				<dd class="text-md weight-600">{signals.context_health.sessions_with_compaction}</dd>
			</div>
		</dl>

		<section class="box gap-2xs">
			<h3 class="text-sm weight-600">Outcome distribution</h3>
		...
		<section class="box gap-2xs">
			<h3 class="text-sm weight-600">Quality signals</h3>
			<ul class="box gap-3xs unstyled">
	...
	{:else}
		<p class="text-muted text-sm">Quality signals are unavailable.</p>
	{/if}
</section>
