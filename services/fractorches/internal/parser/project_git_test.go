...
func TestExtractProjectFromCwdWithBranch(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			cwd:    filepath.FromSlash("/Users/example/code/agentsview-worktree-tool-call-arguments"),
			branch: "worktree-tool-call-arguments",
			want:   "agentsview",
		},
		{
			name:   "BranchWithSlash",
			cwd:    filepath.FromSlash("/Users/example/code/agentsview-feature-worktree-support"),
			branch: "feature/worktree-support",
			want:   "agentsview",
		},
		{
			name:   "MismatchNoTrim",
			cwd:    filepath.FromSlash("/Users/example/code/agentsview-hotfix"),
			branch: "feature/other",
			want:   "agentsview_hotfix",
		},
		{
			name:   "DefaultBranchNoTrim",
			cwd:    filepath.FromSlash("/Users/example/code/project-main"),
			branch: "main",
			want:   "project_main",
		},
		{
			name:   "SupersetWorktreeFlat",
			cwd:    filepath.FromSlash("/Users/example/.superset/worktrees/agentsview/tauri-packaging"),
			branch: "tauri-packaging",
			want:   "agentsview",
		},
		{
			name:   "SupersetWorktreeNested",
			cwd:    filepath.FromSlash("/Users/example/.superset/worktrees/agentsview/fix/worktrees"),
			branch: "fix/worktrees",
			want:   "agentsview",
		},
		{
			name:   "SupersetWorktreeContainerOnly",
			cwd:    filepath.FromSlash("/Users/example/.superset/worktrees/agentsview"),
			branch: "",
			want:   "agentsview",
		},
		{
			name:   "ConductorWorktreeFlat",
			cwd:    filepath.FromSlash("/Users/example/conductor/workspaces/my-app/feature-branch"),
			branch: "feature-branch",
			want:   "my_app",
		},
		{
			name:   "ConductorWorktreeNested",
			cwd:    filepath.FromSlash("/Users/example/conductor/workspaces/my-app/fix/auth-bug"),
			branch: "fix/auth-bug",
			want:   "my_app",
		},
		{
			...
			cwd: filepath.FromSlash(
				"/Users/example/.config/middleman/worktrees/github.com/wesm/middleman/pr-205",
			),
		...
		},
		{
			...
			cwd: filepath.FromSlash(
				"/Users/example/.config/middleman/worktrees/github.com/wesm/middleman/pr-205/internal/parser",
			),
			branch: "fix-exited-agent-session-cleanup",
			want:   "middleman",
		},
		...
		},
		{
			...
			cwd: filepath.FromSlash(
				"/Users/example/.codex/worktrees/44be/middleman/internal/parser",
			),
			branch: "fix-exited-agent-session-cleanup",
			want:   "middleman",
		},
