...
const COMPONENT = resolve(here, "../../src/lib/styles/temp/mdrend.css");
...
function darkModeBlock(): string {
  ...
  expect(start, "dark-mode override block not found in the Markdown renderer stylesheet").toBeGreaterThan(-1);
